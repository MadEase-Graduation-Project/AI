...
class EnhancedAITrainingPipeline:
    ...
    def load_and_preprocess(self):
        """Load and preprocess the AI-augmented dataset"""
        print("🤖 ENHANCED AI-AUGMENTED TRAINING PIPELINE")
        print("=" * 50)
        
        # Initialize preprocessor with AI-augmented data
        self.preprocessor = DataPreprocessorFixed()
        self.preprocessor.initialize_all(use_augmented=False, use_ai_augmented=True)
